...
public class ModPotions {
    ...
    public static final Potion SQUIGGLE_POTION_LONG = registerPotion("squiggle_potion_long",
            new Potion(new StatusEffectInstance(ModEffects.HPSQUIGGLEHEAL, 100, 1)));
